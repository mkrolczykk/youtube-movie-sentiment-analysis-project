...
def render_results():
    ...
    with col1:
        ...
        st.plotly_chart(fig, width='stretch', key="sentiment_distribution")
    
    with col2:
        fig = create_sentiment_histogram(df)
        st.plotly_chart(fig, width='stretch', key="sentiment_histogram")
    ...
    with col1:
        ...
        st.plotly_chart(fig, width='stretch', key="sentiment_by_language")
    ...
    with tab_keywords:
        ...
        with col1:
            ...
            st.plotly_chart(fig, width='stretch', key="keywords_chart")
        with col2:
    ...
    with tab_ngrams:
        ...
        with col1:
            ...
            st.plotly_chart(fig, width='stretch', key="bigrams_treemap")
        ...
        with col2:
            ...
            st.plotly_chart(fig, width='stretch', key="trigrams_treemap")
    ...
    with tab_topics:
        ...
        if len(df) >= 10:
            ...
            if topics:
                ...
                st.plotly_chart(fig, width='stretch', key="topics_chart")
    ...
    with tab_emoji:
        ...
        with col1:
            ...
            st.plotly_chart(fig, width='stretch', key="emoji_chart")
